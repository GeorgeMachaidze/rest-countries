...
function Content({ isDark, setInputValue, getSearchData }) {
  ...
  return (
    <div>
      <div className="flex flex-col items-center gap-[25px] justify-center mt-[32px] pb-[65px] lg:flex-row lg:flex-wrap lg:gap-[60px] ">
        <div
          onClick={handleClick(data && data[227]?.name.common)}
          className="pb-[48px] rounded-[5px] shadow-md cursor-pointer lg:mt-[48px]"
